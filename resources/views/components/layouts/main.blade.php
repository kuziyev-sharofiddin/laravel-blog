 ...
 <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <p class="mb-1">Mon â€“ Sat, 8AM â€“ 5PM</p>
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Biz haqimizda</a>
                <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Xizmatlar</a>
                <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Portfolio</a>
