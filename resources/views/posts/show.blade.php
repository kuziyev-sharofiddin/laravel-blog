        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="row mb-4">
                    ...
                    <form action="{{ route('posts.destroy', ['post'=>$post->id]) }}" method="POST" onsubmit="return confirm('Rostan ham o\'chirishni xohlaysizmi?')">
                        @csrf
                        @method('DELETE')
                ...
                <div class="bg-light rounded p-5">
                    ...
                    <div>
                        ...
                        <a href="{{ route('auth.login')}}">Kirish</a> ni bosing
                    </div>
                    @endauth
                </div>
            </div>
                    ...
                    <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                        ...
                        <div class="d-flex flex-column pl-3">
                            ...
                            <div class="d-flex">
                                ...
                                <small><a class="text-secondary text-uppercase font-weight-medium" href="">{{ $post->content }}</a></small>
                            </div>
                        </div>
                    </div>
                    @endforeach
